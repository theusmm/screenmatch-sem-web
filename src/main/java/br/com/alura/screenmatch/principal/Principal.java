...
public class Principal {
    ...
    private final String APIKEY = "&apikey=f8e0f7b0";
...
*/
        ...
        /*System.out.println("Digite um trecho do título do epísodio: ");
        var trechoTitulo = leitura.nextLine();
        Optional<Episodio> episodioBuscado = episodios.stream()
                .filter(e -> e.getTitulo().toUpperCase().contains(trechoTitulo.toUpperCase()))
                .findFirst();
        if(episodioBuscado.isPresent()) {
            System.out.println("Epísodio encontrado!");
            System.out.println("Temporada: " + episodioBuscado.get().getTemporada());
        } else {
            System.out.println("Epísodio não encontrado!");
        }*/
        ...
        System.out.println("Pior epísodio: " + est.getMin());
